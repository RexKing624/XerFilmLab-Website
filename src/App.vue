...
const copy = {
  ...
  en: {
    ...
    releaseNotes: '1.2 release notes',
  ...
  <div class="site">
    ...
    <main v-if="page === 'home'" class="landing">
      <div class="landing-copy">
        ...
        <a class="download-button" href="/downloads/XerFilmLab-1.2.dmg">
    ...
    <main v-else class="guide">
      ...
      <div class="guide-actions">
        ...
        <a href="/XerFilmLab-1.2.html">{{ t.releaseNotes }} ↗</a>
      </div>
